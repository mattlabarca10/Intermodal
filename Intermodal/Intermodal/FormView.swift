...
struct FormView: View {
    ...
    @State private var stationNames: [String] = [] // To hold station names from StoreManager
        ...
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 20) {
                    ...
                    // Display loaded station names
                    List(stationNames, id: \.self) { station in
                        Text(station) // Display each station name
                    }
                ...
                .onAppear(perform: loadStationNames) // Load station names when the view appears
    ...
    private func loadStationNames() {
        stationNames = StopsManager.shared.getStations() // Load stations from StopsManager
        print("Loaded stations: \(stationNames)") // Print loaded station names to the console
    }
...
// Custom SearchBar component remains unchanged...
